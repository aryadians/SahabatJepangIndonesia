    ...
    <aside id="adminSidebar" class="fixed inset-y-0 left-0 z-40 w-64 bg-slate-900 text-slate-300 shrink-0 flex flex-col h-full transition-transform duration-300 -translate-x-full md:translate-x-0 md:static border-r border-slate-800 select-none">
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-3 space-y-1 text-xs font-semibold custom-sidebar-scroll">
            ...
            <a 
                ...
                class="flex items-center gap-3 px-3 py-2 rounded-xl transition {{ request()->routeIs('admin.exam-questions.*') ? 'bg-japan-600 text-white font-bold shadow-sm' : 'hover:bg-slate-800 hover:text-white text-slate-300' }}"
            >
                <i data-lucide="help-circle" class="w-4 h-4"></i>
                <span>Bank Soal & Ujian CBT</span>
            </a>

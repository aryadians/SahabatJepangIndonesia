            ...
            <div class="relative z-10 max-w-3xl space-y-6 text-center lg:text-left">
                ...
                <div class="pt-4 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                    <button 
                        ...
                        class="w-full sm:w-auto px-8 py-4 rounded-2xl bg-white text-japan-800 font-extrabold text-base shadow-xl hover:bg-red-50 hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2"
                    >
                    ...
                    <a 
                        href="https://api.whatsapp.com/send?phone=6281234567890&text=Halo%20Admin%20LPK%20Sahabat%20Jepang%20Indonesia,%20saya%20tertarik%20mendaftar%20program%20ke%20Jepang" 
                        target="_blank"
                        rel="noopener noreferrer"
                        class="w-full sm:w-auto px-7 py-4 rounded-2xl bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/30 text-white font-bold text-base transition flex items-center justify-center gap-2"
                    >

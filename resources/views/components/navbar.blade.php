    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-20 gap-3">
            ...
            <a href="{{ route('home') }}" class="flex items-center gap-3 group flex-shrink-0">
                ...
                @else
                    <div class="w-10 h-10 rounded-2xl bg-gradient-to-br from-japan-600 to-red-700 text-white flex items-center justify-center font-japanese font-black text-xl shadow-md shadow-red-600/30 group-hover:scale-105 group-hover:rotate-3 transition duration-200 flex-shrink-0">
                        友
                    </div>
                @endif
                <div class="flex flex-col justify-center">
                    <div class="flex items-center gap-1.5">
                        ...
                        <span class="px-1.5 py-0.5 rounded-full text-[9px] font-extrabold bg-red-100 text-japan-700 border border-red-200">
                            LPK & SO
                        </span>
                    </div>
                    <p class="text-[10px] text-slate-500 font-semibold flex items-center gap-1 mt-1 leading-none">
            ...
            <nav class="hidden lg:flex items-center justify-center gap-1 flex-1 mx-2">
                <a href="{{ route('home') }}#beranda" class="px-3 py-2 rounded-xl text-xs xl:text-sm font-bold text-slate-700 hover:text-japan-600 hover:bg-red-50/80 transition">
                    Beranda
                </a>
                
                <a href="{{ route('home') }}#program" class="px-3 py-2 rounded-xl text-xs xl:text-sm font-bold text-slate-700 hover:text-japan-600 hover:bg-red-50/80 transition">
                    Program
                </a>

                <a href="{{ route('exam.simulator') }}" class="px-3 py-2 rounded-xl text-xs xl:text-sm font-bold text-slate-700 hover:text-japan-600 hover:bg-red-50/80 transition flex items-center gap-1.5">
                    <span>Tryout JLPT</span>
                    <span class="px-1.5 py-0.5 rounded-md bg-japan-600 text-white text-[9px] font-black uppercase tracking-wider shadow-xs">CBT</span>
                </a>

                <a href="{{ route('alumni.map') }}" class="px-3 py-2 rounded-xl text-xs xl:text-sm font-bold text-slate-700 hover:text-japan-600 hover:bg-red-50/80 transition flex items-center gap-1">
                    <i data-lucide="map-pin" class="w-3.5 h-3.5 text-japan-500"></i>
                    <span>Peta Alumni</span>
                </a>
                
                <a href="{{ route('home') }}#kalkulator" class="px-3 py-2 rounded-xl text-xs xl:text-sm font-bold text-slate-700 hover:text-japan-600 hover:bg-red-50/80 transition">
                    Simulasi Gaji
                </a>
                
                <a href="{{ route('articles.index') }}" class="px-3 py-2 rounded-xl text-xs xl:text-sm font-bold text-slate-700 hover:text-japan-600 hover:bg-red-50/80 transition">
                    Artikel
                </a>
                ...
                <div class="relative group">
                    <button 
                        type="button" 
                        class="flex items-center gap-1 px-3 py-2 rounded-xl text-xs xl:text-sm font-bold text-slate-700 group-hover:text-japan-600 group-hover:bg-red-50/80 transition"
                    >
                        <span>Lainnya</span>
                    ...
                    <div class="absolute left-1/2 -translate-x-1/2 top-full pt-2 opacity-0 invisible translate-y-2 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-200 z-50 pointer-events-none group-hover:pointer-events-auto">
                        <div class="w-64 bg-white rounded-2xl shadow-2xl border border-red-100 p-2 space-y-1 ring-1 ring-black/5">
                            ...
                            <a href="{{ route('affiliates.public.register') }}" class="flex items-center gap-2.5 p-2 rounded-xl hover:bg-emerald-50 text-slate-700 hover:text-emerald-800 transition">
            ...
            <div class="flex items-center gap-2 sm:gap-2.5 flex-shrink-0">
                ...
                <button 
                    ...
                    class="hidden xl:inline-flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-bold text-amber-800 bg-amber-50 hover:bg-amber-100 border border-amber-200 transition shadow-xs"
                ...
                <button 
                    ...
                    class="btn-red-primary px-4 py-2 rounded-xl text-xs font-extrabold flex items-center justify-center gap-1.5 shadow-md shadow-red-600/20 whitespace-nowrap"
                >

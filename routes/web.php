...
Route::get('/kurikulum-edukasi', [\App\Http\Controllers\SjiGroupController::class, 'curriculum'])->name('education.curriculum');
Route::get('/kurikulum', fn() => redirect()->route('education.curriculum'));
Route::get('/edukasi', fn() => redirect()->route('education.curriculum'));
